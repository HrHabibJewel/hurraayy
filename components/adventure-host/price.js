...
const Price = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    validateFields((err, values) => {
      ...
      $axios.put("adventure/" + adventureId + "/price_per_guest/", JSON.stringify(params)).then(function (resp) {
        if (resp && resp.status == 200) {
          dispatch(
            adventureHost("price", adventureId)
          );
        ...
        <Row>
          <Col span={16}>
            <div className="exp_con">
              ...
              <p>
                You have the freedom of setting price per person. This is the price each person will pay.
            </p>
            </div>
            <div className="exp_con">
              <Row gutter={24}>
              ...
              <table width="100%" className="lh-7x">
                <tbody>
                  ...
                  <tr className="border-bottom">
                    ...
                    <td className="float-right"><TextChange
                      labelName=""
                  ...
                  <tr>
                    <th>You’d make</th>
                    <th className="float-right">${state['numberOfGuest'] + state['pricePerGuest']}</th>
                  </tr>
                </tbody>
              </table>
            </div>
