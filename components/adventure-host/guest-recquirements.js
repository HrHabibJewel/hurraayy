...
const GuestRecquirements = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    validateFields((err, values) => {
      ...
      params["haveAccessibilityFeature"] = values["accessibilityFeatures"];
      params["minAge"] = values["minimumAge"];
      params["skillRequired"] = values["skillLevel"];
      $axios.put("adventure/" + adventureId + "/guest-requirements/", JSON.stringify(params)).then(function (resp) {
        if (resp && resp.status == 200) {
          dispatch(
            adventureHost("guest-requirements", adventureId)
          );
    ...
    <Spin spinning={loading} tip="Loading...">
      <Form onSubmit={handleSubmit}>
        ...
        <div className="exp_con">
          ...
          <p>You may mention if there is any minimum age level required to take part in the adventure and what activity level is involved. </p>
        </div>
        <div className="exp_con">
          {
            console.log("==", state)
          ...
          {/* <Row gutter={24}>
              <Col span={18}>
                  <h5>Does your adventure have any accessibility features?</h5>
                <Form.Item>
          ...
          <Row gutter={24}>
            <Col span={18}>
              <h5>Your adventure requires what activity level?</h5>
              {/* <p>Irure adipisicing voluptate irure culpa velit culpa velit labore.</p> */}
              <Form.Item>
          ...
          <Row gutter={24}>
            <Col span={9}>
              <h5>Does you adventure require a certain level of skills? </h5>
