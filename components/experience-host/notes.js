  ...
  const handleSubmit = (e) => {
    ...
    validateFields((err, values) => {
     let params = {};
        ...
        $axios.put("experience/"+experienceId+"/notes/", JSON.stringify(params)).then(function (resp) {
        if (resp && resp.status == 200) {
          dispatch(
            experienceForm("note", experienceId)
          );
    ...
    <Spin spinning={loading} tip="Loading...">
      ...
      <Form.Item>
        ...
        <div className="exp_con">
          {/* <h2>What else do guests need to know before they book?</h2> */}
          <h2>You can add additional notes for your guests</h2>
          <p>Add notes such as about weather, difficulty level of the experience etc.</p>
        </div>
