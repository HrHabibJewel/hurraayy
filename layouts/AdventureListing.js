        ...
        <div className="row">
          <div className="w-20" style={{ background: "#FCFCFC" }}>
            <div className="pl-3">
              ...
              <h2 className="ff-heebo fs-20 fw-500 mt-3">Adventure Listing</h2>
            </div>
            {/* collapsed */}
            <Collapse
              className="exp-left"
            ...
            >
              {menuList.map((item) => (
                ...
                >
                  ...
                  {item.children.map((child, i) => (
                    <div className="pb-3 pl-5" style={{ cursor: "pointer" }} key={i}>
                      {
                        <Icon
                          type="check-circle"
                          style={{
                            color:
                              Number(child.stepAndPageTogetherNo) ===
                                Number(step + "" + page)
                                ? "#15D59B"
                                : Number(child.stepAndPageTogetherNo) <
                                  Number(step + "" + page)
